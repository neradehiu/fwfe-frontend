...
class PrivateChatService {
  ...
  Future<void> connect({
    ...
    _stompClient = StompClient(
      config: StompConfig.SockJS(
        url: 'https://fwfedevhieu.duckdns.org/ws',
  ...
  Future<void> markAsReadRest(int messageId) async {
    ...
    final url =
    Uri.parse('https://fwfedevhieu.duckdns.org/api/chat/mark-read/$messageId');
  ...
  Future<List<Map<String, dynamic>>> fetchPrivateMessageHistory(
    ...
    final url = Uri.parse(
        'https://fwfedevhieu.duckdns.org/api/chat/chat/history/private?user=$receiverUsername&limit=50');
  ...
  Future<List<String>> getPrivateSenders(String myUsername) async {
    ...
    final uri = Uri.parse(
        'https://fwfedevhieu.duckdns.org/api/chat/chat/private/inbox?myUsername=$encodedUsername');
